...
<td><div class="col-md-12 mb-3">    
     ...
     <input type="text" name="codigo" class="form-control" style="text-align: center;" value= "<?php echo $codigo?>">  
</div>
</td>
<td><div class="col-md-12 mb-3"> 
     <label for="firstName" class="form-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
...
<td><div class="col-md-12 mb-3"> 
     <label for="firstName" class="form-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
     Precio de ventas</font></font></label>     
     <input type="text" name="precio" class="form-control" style="text-align: center;" value= "<?php echo $precio?>">  
</div></td>

<td><div class="col-md-12 mb-3"> 
     <label for="firstName" class="form-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
     Precio Costos</font></font></label>     
     <input type="text" name="precio" class="form-control" style="text-align: center;" value= "<?php echo $precio?>">  
</div></td>
<td><div class="col-md-12 mb-3"> 
     <label for="firstName" class="form-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
     Categoria</font></font></label>     
     <input type="text" name="categoria" class="form-control" style="text-align: center;" value= "<?php echo $categoria?>">  
</div></td>
